...
(() => {
			...
			success: (response) => {
				...
				for (var i in response) {
					...
					let $picture = `
						<picture>
							${
								"image_webp" in response[i]
									? `<source type="image/webp" srcset="${response[i].image_webp}">`
									: ""
							}
						    <img src="${
								response[i].image_jpg
							}" class="video__preview object-fit" alt="">
						</picture>
					`;
					...
					if ($item.length) {
						...
						setTimeout(function () {
							$item
								.find(".reviews__name span")
								.text(response[i].name);
							$item
								.find(".reviews__who span")
								.text(response[i].who);
							$item
								.find(".reviews__text")
							...
							$item
								.find(".reviews__video")
								.attr("data-youtube", response[i].youtube);
							...
							.trigger("add.owl.carousel", [
								...
								<div class="reviews__row flex flex_vertical" id="${response[i].id}">
			                        ...
			                        <div class="reviews__cell reviews__cell_content">
			                            ...
			                            <div class="reviews__nav flex flex_vertical"><a class="reviews__button btn h6" href="#"><span class="btn__circle"></span><span class="btn__text">Читать полностью</span></a><a class="reviews__apply red-link h6" href="#">Обратиться в&nbsp;мбк</a>
			                            </div>
			                        </div>
			                    </div>
							`,
				...
				$reviews
					.find(".btn:not(.is-initialized)")
					.on("mousemove", buttonInit);
			},
		});
	};
	...
	$reviews
		.owlCarousel({
			...
			touchDrag: false,
			navText: [
				'<svg viewBox="0 0 18.560659 9.6213207"><path class="triangle" d="M14.5 4.81v-3l3 3-3 3z"></path><path class="stroke" d="M14.764 4.864l-.193.23-.61-.133.539-.15m0 0v-3l3 3-3 3zM.007 4.151h13.79v1.542H.007z"></path></svg>',
				'<svg viewBox="0 0 18.560659 9.6213207"><path class="triangle" d="M14.5 4.81v-3l3 3-3 3z"></path><path class="stroke" d="M14.764 4.864l-.193.23-.61-.133.539-.15m0 0v-3l3 3-3 3zM.007 4.151h13.79v1.542H.007z"></path></svg>',
			],
			responsive: {
				0: {
				...
				769: {
					touchDrag: false,
					navText: [
						'<svg class="icon-arrow" fill="none" version="1.1" viewBox="0 0 18.561 9.6213" xmlns="http://www.w3.org/2000/svg"><g shape-rendering="auto"><path d="m13.75 0v4.0605h-13.75v1.5h13.75v4.0605l4.8105-4.8105z" /></g></svg>',
						'<svg class="icon-arrow" fill="none" version="1.1" viewBox="0 0 18.561 9.6213" xmlns="http://www.w3.org/2000/svg"><g shape-rendering="auto"><path d="m13.75 0v4.0605h-13.75v1.5h13.75v4.0605l4.8105-4.8105z" /></g></svg>',
					],

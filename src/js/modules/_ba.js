...
$(function() {
	...
	const onMouseleave = function() {
		if ($('.we-sell__comment-opener:hover').length === 0 && $('.we-sell__help:hover').length === 0) {
	...
	$('.ba').on('mousemove touchmove touchstart', onMousemoveTouchmoveTouchstart).on('mouseleave', onMouseleave).on('mouseenter', onMouseEnter);
